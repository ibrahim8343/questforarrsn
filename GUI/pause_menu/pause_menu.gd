...
@onready var button_save: Button = $"Control/TabContainer/الاعدادات/VBoxContainer/Button_Save"
@onready var button_load: Button = $"Control/TabContainer/الاعدادات/VBoxContainer/Button_Load"
@onready var button_quit: Button = $"Control/TabContainer/الاعدادات/VBoxContainer/Button_Quit"

@onready var item_description: Label = $"Control/TabContainer/الحقيبة/ItemDescription"
